...
function displaySummary(){
    ...
    displayOrderDetails($Fullname, $Choose, $Quality, $Quantity, $Address ,$Method, $Phone, $Email, $total, $Information);
...
*/
function displayOrderDetails($Fullname, $Choose, $Quality, $Quantity, $Address ,$Method, $Phone, $Email, $total, $Information)
    {
